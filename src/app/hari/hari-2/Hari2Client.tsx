        ...
        <section className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
          ...
          <div className="mt-4 overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 to-zinc-800 p-8 shadow-xl dark:from-zinc-900 dark:to-black">
            ...
            <p className="mt-1 text-sm text-white/50">
              ...
              pedoman kerja yang akan sering kamu akses sesuai dengan peran saat ini.
            </p>
            <div className="mt-6">
          ...
          {/* ══════════════════════════════════════════════
              1 — Mengenal Ekosistem Kerja CISDI
          ══════════════════════════════════════════════ */}
          <SectionHeader num="1">Mengenal Ekosistem Kerja CISDI</SectionHeader>

          <Toggle title="Praktik GEDSI dalam Lingkungan CISDI" icon="⚖️" accent="purple">
            <Callout>
          ...
          <Toggle title="Mitigasi Perilaku Kekerasan dan Pelecehan di Lingkungan Kerja CISDI" icon="🛡️" accent="red">
            <Callout>
              CISDI menerapkan kebijakan internal untuk mencegah dan menangani
              tindak kekerasan/pelecehan di lingkungan kerja.{" "}
              <strong>Pelajari</strong>{" "}
          ...
          <Toggle title="Mitigasi Perilaku Penggelapan dan KKN di Lingkungan Kerja CISDI" icon="🔍" accent="blue">
            <Callout>
              CISDI menerapkan kebijakan internal untuk mencegah dan menangani
          ...
          <Toggle title="SOP, Kebijakan, dan Pedoman Internal" icon="📋" accent="green">
            <Callout>
              <p>
          ...
          {/* ══════════════════════════════════════════════
              2 — Menggunakan dan Mengimplementasi Pedoman
          ══════════════════════════════════════════════ */}
          <SectionHeader num="2">Menggunakan dan Mengimplementasi Pedoman</SectionHeader>

          <Toggle title="Pedoman Penamaan dan Penyimpanan Dokumen" icon="🗂️" accent="yellow">
            <Callout>
          ...
          <Toggle title={<span>Rencana Kerja (w<em>ork plan</em>) Unit Departemen/Project</span>} icon="📅" accent="blue">
            <Callout>
              <p>
              ...
              <p className="mt-1">
                Simak pembahasan rencana kerja tahun berjalan dari tautan laman di bawah ini.
              </p>
            </Callout>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-200 bg-zinc-50 dark:border-white/10 dark:bg-white/5">
                      <th className="px-4 py-2 text-left font-medium text-zinc-700 dark:text-white/70">Nama Kegiatan/Aktivitas</th>
                      <th className="px-4 py-2 text-left font-medium text-zinc-700 dark:text-white/70 w-28">Status</th>
                      <th className="px-4 py-2 text-left font-medium text-zinc-700 dark:text-white/70 w-36">Tanggal Kegiatan</th>
                    </tr>
                  </thead>
                  <tbody>
                    {KALENDER_EVENTS.map((ev, i) => (
                      <tr key={i} className="border-b border-zinc-100 last:border-0 dark:border-white/5">
                        <td className="px-4 py-2.5 text-zinc-700 dark:text-white/70">{ev.name}</td>
                        ...
                        <td className="px-4 py-2.5 text-zinc-500 dark:text-white/50 text-xs">{ev.date}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="mt-5 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <ol className="ml-4 list-decimal space-y-1.5 text-sm text-zinc-600 dark:text-white/60">
                ...
                <li>Catat apa saja hal yang ingin kamu ketahui dari Supervisor terkait rencana kerja yang akan dilakukan,</li>
                <li>Diskusikan hal tersebut dalam pertemuan yang sudah kamu jadwalkan.</li>
              </ol>
              <div className="mt-3">
                <CheckItem id="d2-tugas-mandiri" isDone={d("d2-tugas-mandiri")} onToggle={t("d2-tugas-mandiri")}>
                  Selesaikan tugas mandiri membuat draf diskusi rencana kerja (3 langkah)
                </CheckItem>
              </div>
            </div>
          </Toggle>

          <Toggle title="Alur Pengajuan Reguler" icon="⚡" accent="red">
            <Callout>
              <p>
              ...
              <p className="mt-2">
                ...
                <em>regular request</em> yang berlaku dari divisi-divisi di CISDI.
              </p>
            </Callout>
            ...
            <div className="mt-3 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.03]">
                <p className="mb-2 font-semibold text-sky-600 dark:text-sky-400">Finance &amp; Administration</p>
                <ul className="space-y-1.5 text-sm text-zinc-600 dark:text-white/60">
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Pengadaan Barang dan Jasa</li>
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 shrink-0">💵</span> Panduan Pengajuan Nota Keuangan</li>
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Penggunaan Ruangan Kantor CISDI</li>
                </ul>
                <div className="mt-3">
              ...
              {/* Human Capital */}
              <div className="rounded-2xl border border-zinc-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.03]">
                <p className="mb-2 font-semibold text-sky-600 dark:text-sky-400">Human Capital</p>
                <ul className="space-y-1.5 text-sm text-zinc-600 dark:text-white/60">
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Pengajuan Cuti dan Pengganti Hari</li>
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Pengajuan Lembur</li>
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Pengajuan Kegiatan Belajar Internal Karyawan CISDI</li>
                </ul>
                <div className="mt-3">
              ...
              {/* Knowledge & Learning */}
              <div className="rounded-2xl border border-zinc-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.03]">
                <p className="mb-2 font-semibold text-sky-600 dark:text-sky-400">Knowledge &amp; Learning</p>
                <ul className="space-y-1.5 text-sm text-zinc-600 dark:text-white/60">
                  <li className="flex items-start gap-1.5"><span className="mt-0.5 text-red-500 shrink-0">🔖</span> Panduan Unggah Konten ke Website CISDI</li>
                </ul>
                <div className="mt-3">
            ...
            {/* Praktik Mandiri */}
            <div className="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-white/10 dark:bg-white/[0.03]">
              <h4 className="mb-2 font-semibold text-red-600 dark:text-red-400">
              ...
              <p className="mb-2 text-sm text-zinc-600 dark:text-white/60">
                ...
                praktik secara langsung dengan mengikuti langkah-langkah berikut:
              </p>
              <ol className="ml-4 list-decimal space-y-1.5 text-sm text-zinc-600 dark:text-white/60">
                <li>Kirim pengajuan cuti mengikuti langkah-langkah yang ada,</li>
                <li>
                  Sematkan kata{" "}
                ...
                <li>Tag <strong>@Yurdhinda Aprilia</strong> dan <strong>@ayu.purnamasari@cisdi.org</strong> juga, ya!</li>
                <li>Setelahnya praktik pengajuan ini akan mendapatkan respons dari Supervisor dan tim human Capital.</li>
              </ol>
              <div className="mt-3">
          ...
          ══════════════════════════════════════════════ */}
          <SectionHeader num="3">Refleksi Pembelajaran</SectionHeader>

          <div className="mb-4 overflow-hidden rounded-2xl border border-red-200 bg-red-50 p-5 dark:border-red-500/20 dark:bg-red-500/10">
          ...
          <div className="mt-10 overflow-hidden rounded-3xl bg-gradient-to-br from-red-600 to-red-700 p-6 shadow-lg shadow-red-600/20">
            ...
            <p className="mb-4 text-sm text-red-100">
              ...
              materi asinkronus laman program orientasi karyawan CISDI hari kedua.
            </p>
            <div
              onClick={t("d2-sesi")}
              role="checkbox"
              aria-checked={d("d2-sesi")}
              tabIndex={0}
              onKeyDown={(e) => e.key === " " && t("d2-sesi")()}
            ...
            >
              <span className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-all ${d("d2-sesi") ? "border-white bg-white text-red-600" : "border-white/50"}`}>
                <Check className="h-3 w-3" strokeWidth={3} />
              </span>
              <span className={`text-sm font-medium ${d("d2-sesi") ? "line-through" : ""}`}>
